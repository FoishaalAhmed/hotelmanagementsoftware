...
class CostController extends Controller
{
    ...
    {
        $costs = Cost::where('hotel_id', auth()->user()->hotel_id)->where('type', 3)->get();
        ...
        return view('backend.parking.cost', compact('costs', 'banks', 'mobileBanks'));
    }
    ...
    public function edit(Cost $cost)
    {
        ...
        return view('backend.parking.cost', compact('costs', 'cost'));
    }
    ...
    public function update(Request $request, Cost $cost)
    {
        ...
        return redirect()->route('parking.costs.index');
    }
