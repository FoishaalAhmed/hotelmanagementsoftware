...
class CostController extends Controller
{
    ...
    {
        $costs = Cost::where('hotel_id', auth()->user()->hotel_id)->where('type', 5)->get();
        ...
        return view('backend.laundry.cost', compact('costs', 'banks', 'mobileBanks'));
    }
    ...
    public function edit(Cost $cost)
    {
        ...
        $banks = Bank::where('hotel_id', auth()->user()->id)->select('id', 'name')->get();
        $mobileBanks = MobileBank::where('hotel_id', auth()->user()->id)->select('id', 'name')->get();
        return view('backend.laundry.cost', compact('costs', 'cost', 'banks', 'mobileBanks'));
    }
    ...
    public function update(Request $request, Cost $cost)
    {
        ...
        return redirect()->route('laundry.costs.index');
    }
