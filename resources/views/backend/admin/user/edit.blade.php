                    ...
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ route('admin.users.index') }}" class="btn btn-sm bg-green"><i
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input name="name" placeholder="{{ __('Name') }}" class="form-control"
                                                    required="" type="text" value="{{ $user->name }}" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="address" rows="3" class="form-control"
                                                    ...
                                                    style="resize: vertical;">{{ $user->address }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box box-primary box-solid">
                                        ...
                                        <div class="box-body box-profile">
                                            <img class="profile-user-img img-responsive img-circle"
                                                src="{{ asset($user->photo) }}" alt="User profile picture"
                                                id="user-photo" style="width: 120px; height:120px;">
