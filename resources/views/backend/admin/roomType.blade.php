...
@section('content')
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <a href="#" class="btn btn-sm bg-green" data-toggle="modal" data-target="#myModal"><i
                                        class="fa fa-plus"></i> New Room Type</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{ __('New Room Type') }}</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.types.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2">{{ __('Type') }}</label>
                            <div class="col-sm-9">
                                <input name="type" placeholder="{{ __('Type') }}" class="form-control" required=""
                                    type="text" value="{{ old('type') }}" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <center>
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Room Type Update</h4>
                </div>
                <div class="modal-body">
                    <form id="edit-form" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2">{{ __('Type') }}</label>
                            <div class="col-sm-9">
                                <input name="type" id="type" placeholder="{{ __('Type') }}" class="form-control"
                                    required="" type="text" value="{{ old('type') }}" autocomplete="off">
    ...
    <script type="text/javascript">
        $('#edit-modal').on("show.bs.modal", function(event) {
            ...
            var action = '{{ URL::to('/admin/types/update') }}';
