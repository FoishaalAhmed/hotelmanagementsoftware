...
@section('content')
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 70%">Review Category</th>
                                    ...
                                    @foreach ($categories as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form
                                                    action="{{ route('admin.review-categories.destroy', [$item->id]) }}"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{ __('New Review Category') }}</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.review-categories.store') }}" method="POST"
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Review Category Update</h4>
                </div>
                <div class="modal-body">
    ...
    <script type="text/javascript">
        $('#edit-modal').on("show.bs.modal", function(event) {
            ...
            var action = '{{ URL::to('/admin/review-categories/update') }}';
