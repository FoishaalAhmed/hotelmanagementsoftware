                                            ...
                                            <td>
                                                @if ($item->status == 0)
                                                    <a class="btn btn-sm bg-blue"
                                                        href="{{ route('admin.room-reviews.status', [$item->id, 1]) }}">Approve</a>
                                                @else
                                                    <a class="btn btn-sm bg-blue"
                                                        href="{{ route('admin.room-reviews.status', [$item->id, 0]) }}">Disapprove</a>
                                                @endif

                                                <form action="{{ route('admin.room-reviews.destroy', [$item->id]) }}"
