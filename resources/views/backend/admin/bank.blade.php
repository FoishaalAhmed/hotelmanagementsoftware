                ...
                <div class="box box-teal box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <a href="#" class="btn btn-sm bg-green" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> New Bank</a>
                        </div>		
                    </div>
                    <!-- /.box-header -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	...
                                    	<form action="{{route('admin.banks.destroy',$bank->id)}}" method="post" style="display: none;" id="delete-form-{{ $bank->id}}">
                                            @csrf
                                            {{method_field('DELETE')}}
                                        </form>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('admin.banks.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="edit-modal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Bank Update</h4>
        </div>
        <div class="modal-body">
  ...
  <script type="text/javascript">
    $('#edit-modal').on("show.bs.modal", function(event){
        ...
        var action = '{{URL::to('admin/banks/update')}}';
