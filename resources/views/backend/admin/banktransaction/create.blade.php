            ...
            <div class="col-md-12">
                ...
                <div class="box box-teal box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">New bank transaction</h3>
                    ...
                    <div class="box-body">
                    	...
                    	<form action="{{route('admin.bank-transactions.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    		@csrf
                            <div class="col-md-6">
