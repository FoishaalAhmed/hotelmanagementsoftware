...
@section('title', 'Room Review Category')
@section('content')
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-teal box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">Room Review Category</h3>
                            <div class="box-tools pull-right">
                                <a href="#" class="btn btn-sm bg-green" data-toggle="modal" data-target="#myModal"><i
                                        class="fa fa-plus"></i> New Room Review Category</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 70%">Room Review Category</th>
                                    ...
                                    @foreach ($categories as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form
                                                    action="{{ route('admin.room-review-categories.destroy', [$item->id]) }}"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{ __('New Room Review Category') }}</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('admin.room-review-categories.store') }}" method="POST"
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Room Review Category Update</h4>
                </div>
                <div class="modal-body">
    ...
    <script type="text/javascript">
        $('#edit-modal').on("show.bs.modal", function(event) {
            ...
            var action = '{{ URL::to('/admin/room-review-categories/update') }}';
