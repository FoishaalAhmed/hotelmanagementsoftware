...
@section('content')
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <a href="#" class="btn btn-sm bg-green" data-toggle="modal" data-target="#myModal"><i
                                        class="fa fa-plus"></i> New Vehicle Category</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 70%">Vehicle Category</th>
                                    ...
                                    @foreach ($categories as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form
                                                    action="{{ route('parking.categories.destroy', [$item->id]) }}"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{ __('New Vehicle Category') }}</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('parking.categories.store') }}" method="POST"
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Vehicle Category Update</h4>
                </div>
                <div class="modal-body">
    ...
    <script type="text/javascript">
        $('#edit-modal').on("show.bs.modal", function(event) {
            ...
            var action = '{{ URL::to('/parking/categories/update') }}';
