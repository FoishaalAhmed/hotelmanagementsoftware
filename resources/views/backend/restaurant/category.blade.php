...
@section('content')
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                <a href="#" class="btn btn-sm bg-green" data-toggle="modal" data-target="#myModal"><i
                                        class="fa fa-plus"></i> New Food Category</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                                    ...
                                    @foreach ($categories as $key => $type)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('restaurant.categories.destroy', $type->id) }}"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('restaurant.categories.store') }}" method="POST" class="form-horizontal"
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Food Category Update</h4>
                </div>
                <div class="modal-body">
    ...
    <script type="text/javascript">
        $('#edit-modal').on("show.bs.modal", function(event) {
            ...
            var action = '{{ URL::to('restaurant/categories/update') }}';
