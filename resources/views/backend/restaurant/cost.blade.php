                    ...
                    <div class="box box-teal box-solid">
                        ...
                        <div class="box-body" id="box-body">
                            ...
                            @if (!isset($cost))
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="{{ route('restaurant.costs.store') }}" method="post"
                            ...
                            @else
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="{{ route('restaurant.costs.update', $cost->id) }}" method="post"
                                            class="form-horizontal">
                                            @csrf
                                            @method('PUT')
                                            <div class="col-md-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{-- <a class="btn btn-sm bg-teal"
                                                            href="{{ route('restaurant.costs.edit', $item->id) }}"><span
                                                                class="glyphicon glyphicon-edit"></span></a> --}}
                                                        {{-- <form action="{{ route('restaurant.costs.destroy', $item->id) }}"
