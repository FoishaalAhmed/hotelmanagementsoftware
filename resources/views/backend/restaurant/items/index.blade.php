                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ __('Item List') }}</h3>
                            <div class="box-tools pull-right">
                                <a href="{{ route('restaurant.items.create') }}" class="btn btn-sm bg-green"><i
                                        class="fa fa-plus"></i> {{ __('New Item') }}</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm bg-blue"
                                                    href="{{ route('restaurant.items.edit', [$item->id]) }}"><span
                                                        class="glyphicon glyphicon-edit"></span></a>

                                                <form action="{{ route('restaurant.items.destroy', [$item->id]) }}"
