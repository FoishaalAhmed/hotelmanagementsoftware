...
@section('content')
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                <a href="#" class="btn btn-sm bg-green" data-toggle="modal" data-target="#myModal"><i
                                        class="fa fa-plus"></i> New Food Type</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-sm bg-teal" href="#" data-toggle="modal"
                                                    ...
                                                    data-name="{{ $type->name }}"><span
                                                        class="glyphicon glyphicon-edit"></span></a>

                                                <form action="{{ route('restaurant.types.destroy', $type->id) }}"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">New Food Type</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('restaurant.types.store') }}" method="POST" class="form-horizontal"
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Food Type Update</h4>
                </div>
                <div class="modal-body">
    ...
    <script type="text/javascript">
        $('#edit-modal').on("show.bs.modal", function(event) {
            ...
            var action = '{{ URL::to('restaurant/types/update') }}';
