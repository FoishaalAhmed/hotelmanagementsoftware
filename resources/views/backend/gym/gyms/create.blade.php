                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ __('New Gym') }}</h3>
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('gym.gyms.store') }}" method="POST" class="form-horizontal"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <select name="type" class="form-control" id="type" style="width: 100%"
                                                    required=''>
                                                    <option value="Male" @if (old('type') == 'Male') {{ 'selected' }}

                                                        @endif>{{ __('Male') }}</option>
                                                    <option value="Female" @if (old('type') == 'Female') {{ 'selected' }}

                                                        @endif>{{ __('Female') }}</option>

                                                    <option value="Combine" @if (old('type') == 'Combine') {{ 'selected' }}
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <select name="trainer" class="form-control" id="trainer"
                                                    ...
                                                    <option value="1" @if (old('trainer') == 1)
                                                        {{ 'selected' }}

                                                        @endif>{{ __('Available') }}</option>
                                                    <option value="0" @if (old('trainer') == 0)
                                                        {{ 'selected' }}
