...
@section('title', 'New Laundry Charge')
@section('content')
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ __('New Laundry Charge') }}</h3>
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('laundry.charges.store') }}" method="POST" class="form-horizontal"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select name="laundry_product_id" class="form-control select2" id="laundry_product_id"
                                                    ...
                                                    @foreach ($products as $item)
                                                        <option value="{{ $item->id }}" @if (old('laundry_product_id') == $item->id) {{ 'selected' }} @endif>
                                                            {{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <select name="type" class="form-control" id="type" style="width: 100%"
                                                    required=''>
                                                    <option value="Normal" @if (old('type') == 'Normal') {{ 'selected' }}

                                                        @endif>{{ __('Normal') }}</option>
                                                    <option value="Dry" @if (old('type') == 'Dry') {{ 'selected' }}
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input name="charge" placeholder="{{ __('Charge') }}"
                                                    class="form-control" type="numeric" value="{{ old('charge') }}"
