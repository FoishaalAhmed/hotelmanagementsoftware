<footer class="main-footer">
    ...
    <strong>Copyright &copy; {{ date('Y') }} <a href="{{ URL::to('/') }}">Amarlodge</a>.</strong> All rights
    reserved.
</footer>
<!-- Control Sidebar -->
...
<!-- datepicker -->
<script
src="{{ asset('public/backend/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}">
</script>
<!-- Bootstrap WYSIHTML5 -->
...
<script src="{{ asset('public/backend/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js') }}">
</script>
